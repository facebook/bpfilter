...
struct bf_cgen
{
     ...
     * Created by default in `bf_cgen_new`. Passed to `bf_program` during
     * generation, which populates it. The program is discarded after
     * generation, only the handle is kept. */
