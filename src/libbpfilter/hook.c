                                      ...
                                      const char *raw_opt)
{
    ...
    if (hookopts->used_opts & BF_FLAG(BF_HOOKOPTS_IFINDEX))
        return bf_err_r(-EEXIST, "ifindex= is defined mutliple times");
                                     ...
                                     const char *raw_opt)
{
    ...
    if (hookopts->used_opts & BF_FLAG(BF_HOOKOPTS_CGPATH))
        return bf_err_r(-EEXIST, "cgpath= is defined mutliple times");
                                     ...
                                     const char *raw_opt)
{
    ...
    if (hookopts->used_opts & BF_FLAG(BF_HOOKOPTS_FAMILY))
        return bf_err_r(-EEXIST, "family= is defined mutliple times");
                                         ...
                                         const char *raw_opt)
{
    ...
    if (hookopts->used_opts & BF_FLAG(BF_HOOKOPTS_PRIORITIES))
        return bf_err_r(-EEXIST, "priorities= is defined mutliple times");
