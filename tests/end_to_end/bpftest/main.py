...
"""End-to-end testing framework for bpfilter.

This framework provides facilities for e2e testing of bpfilter.
"""
...
class BpfilterEndToEndTest(unittest.TestCase):
    ...
    def send(self, pkt: Any) -> Any:
        ...
        return Network.send(pkt, iface=self.dev1)
