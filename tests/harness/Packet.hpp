...
struct Ethernet
{
    static constexpr std::array<uint8_t, kEthernetAddrLen> kDefaultDst = {
        0x02, 0, 0, 0, 0, 0x01};
    static constexpr std::array<uint8_t, kEthernetAddrLen> kDefaultSrc = {
        0x02, 0, 0, 0, 0, 0x02};

    std::array<uint8_t, kEthernetAddrLen> dst = kDefaultDst;
    std::array<uint8_t, kEthernetAddrLen> src = kDefaultSrc;
