...
Test(ip6, nexthdr)
{
    ...
    bft_e2e_test(next_accept, BF_VERDICT_ACCEPT, pkt_local_ip6_hop_low);
    bft_e2e_test(next_accept, BF_VERDICT_ACCEPT, pkt_local_ip6_hop_high);
    ...
    bft_e2e_test(next_drop, BF_VERDICT_DROP, pkt_local_ip6_hop_low);
    bft_e2e_test(next_drop, BF_VERDICT_DROP, pkt_local_ip6_hop_high);
}
