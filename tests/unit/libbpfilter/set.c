...
static void union_basic(void **state)
{
    ...
    assert_ok(bf_set_union(dest, to_add));

    assert_int_equal(bf_list_size(&dest->elems), 3);
}

static void union_mismatched_key_count(void **state)
{
    _free_bf_set_ struct bf_set *dest = NULL;
    _free_bf_set_ struct bf_set *to_add = NULL;
    ...
    assert_err(bf_set_union(dest, to_add));
}

static void union_mismatched_key_type(void **state)
{
    _free_bf_set_ struct bf_set *dest = NULL;
    _free_bf_set_ struct bf_set *to_add = NULL;
    enum bf_matcher_type key1[] = {BF_MATCHER_IP4_SADDR};
...
static void difference_basic(void **state)
{
    _free_bf_set_ struct bf_set *dest = NULL;
    ...
    assert_ok(bf_set_difference(dest, to_remove));

    assert_int_equal(bf_list_size(&dest->elems), 2);
}

static void difference_disjoing_sets(void **state)
{
    _free_bf_set_ struct bf_set *dest = NULL;
    _free_bf_set_ struct bf_set *to_remove = NULL;
    enum bf_matcher_type key[] = {BF_MATCHER_IP4_SADDR};
...
static void difference_mismatched_key_count(void **state)
{
    _free_bf_set_ struct bf_set *dest = NULL;
    _free_bf_set_ struct bf_set *to_remove = NULL;
    enum bf_matcher_type key1[] = {BF_MATCHER_IP4_SADDR};
    ...
    assert_err(bf_set_difference(dest, to_remove));
}

static void difference_mismatched_key_type(void **state)
{
    _free_bf_set_ struct bf_set *dest = NULL;
    _free_bf_set_ struct bf_set *to_remove = NULL;
    enum bf_matcher_type key1[] = {BF_MATCHER_IP4_SADDR};
...
int main(void)
{
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(union_basic),
        cmocka_unit_test(union_mismatched_key_count),
        cmocka_unit_test(union_mismatched_key_type),
        cmocka_unit_test(difference_basic),
        cmocka_unit_test(difference_disjoing_sets),
        cmocka_unit_test(difference_mismatched_key_count),
        cmocka_unit_test(difference_mismatched_key_type),
    };
